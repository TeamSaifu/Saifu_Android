...
import com.ze20.saifu.ui.budget.spendRecyclerview.RecyclerViewHolder
import com.ze20.saifu.ui.budget.spendRecyclerview.RowModel
import com.ze20.saifu.ui.budget.spendRecyclerview.ViewAdapter
import kotlinx.android.synthetic.main.activity_spend_settings.*
...
val spendDataList = mutableListOf<RowModel>()
...
class SpendActivity : AppCompatActivity() {
        ...
        try {
            ...
            if (cursor.count > 0) {
                ...
                while (!cursor.isAfterLast) {
                    arrayListlayout.add(View.inflate(this, R.layout.activity_spend_list, null))
    ...
    private fun getSwipeToDismissTouchHelper(adapter: RecyclerView.Adapter<RecyclerViewHolder>) =
        ItemTouchHelper(object :
            ...
            override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
                ...
                spendDataList.removeAt(viewHolder.adapterPosition)
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            R.id.SpendButton -> startActivity(Intent(this, spend_add::class.java))
        }
        return false
    }
